    ...
    <div className="px-5 lg:px-20">
      <section>
        <h3 className="text-gray-500 py-2 mt-10">
          {`Home/india/Zosh Restaurant/2/Order online`}
        </h3>
        <div>
          <img
        ...
        <div>
          <h1 className="text-4xl py-1 font-semibold">{`Blitz Bite`}</h1>
          <p className="text-gray-500">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum
            vero recusandae dicta in, optio error itaque necessitatibus iste
            assumenda, consectetur doloremque dolores dignissimos iure illo
            delectus, minus impedit consequuntur quae.
          </p>
